...
```{r}
# ============================================================
# STEP A — Extract Urology Attended Appointments from SQL → CSV
# ============================================================
...
specialty   <- "Urology"
year_target <- 2025
output_file <- "data/appointments_urology_fy2025.csv"
...
# ---- SQL Query ----
specialty_like <- paste0(specialty, "%")
...
sql_query <- glue_sql("
  ...
  JOIN HealthCentral.CIM.vwIP_DescSpecialtyProgramForCube AS sp
    ON a.ClinicSpecialtyProviderRowIdentifier = sp.ProviderRowIdentifier
  WHERE a.FinancialYear = {year_target}
    AND sp.MedicalSpecialty LIKE {specialty_like}
    AND ISNULL(a.TotalAttended,0) = 1  -- attended only
", .con = con)

# ---- Get data ----
df_attended <- dbGetQuery(con, sql_query)

# ---- Save to CSV ----
dir.create("data", showWarnings = FALSE, recursive = TRUE)
write.csv(df_attended, output_file, row.names = FALSE)
message("✅ Saved attended appointment data to: ", output_file)
